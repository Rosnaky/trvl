    ...
    return (
        <div className="flex flex-col mt-20">
            <Link href={"/build/step0"}>
                <button
                    className="ml-30 mb-4 text-ui px-8 py-2 rounded-lg border-ui cursor-pointer hover:bg-[#f4f4f420] transition-all"
                >
                    <img src='/chevron-left.svg' className="inline h-4 mb-0.5"/> Back 
                </button>
            </Link>
            <h2 className="text-4xl text-black text-center w-screen text-ui font-bold">When?</h2>
            <div className="mt-16">
                <DayPicker
                    animate
                    className="text-ui flex justify-center"
                    mode="range"
                    numberOfMonths={2}
                    min={1}
                    max={7}
            ...
            <div className={"w-1/1 items-center justify-center flex flex-row"}>
                <Link href={"/build/step2"} className="flex opacity-60 hover:opacity-100 transition duration-200 text-center text-ui cursor-pointer mt-4">I'm flexible</Link>
            </div>
