       ...
       <div className="flex justify-center flex-col h-3/4 w-3/4 gap-10 max-w-300 min-w-100 max-h-600">
        ...
        <div className="relative flex-col justify-center items-center">
          <div className="ml-auto mr-auto w-1/1 max-w-200 justify-center">
            <div className="overflow-hidden flex-row relative min-h-10 rounded-xl bg-white items-center border-1 border-gray-300 shadow-xl ring-black-800">
              ...
              <div className="group absolute bg-theme-blue left-9/10 right-0 top-0 bottom-0 hover:cursor-pointer hover:bg-foreground">
                <Image width="20" height="20" stroke="white" src={"/search.svg"} alt="" className="absolute group-hover:scale-115 transition flex w-3/5 h-3/5 m-auto mt-1.5"/>
              </div>
            </div>
        ...
        <div className="overflow-hidden flex flex-grow justify-between items-center gap-10 mt-4 w-1/1">
          <div className="group hover:cursor-pointer hover:to-background/10 z-2 relative left-0 bg-linear-to-r from-background to-background/0 h-1/1 w-1/8 min-w-10">
          ...
          <div className="relative h-1/1 w-1/1">
            <div className="absolute -left-200 -right-200 top-0 bottom-0">
              <div className="flex flex-row justify-center items-center gap-10 h-1/1">
                <div className="relative rounded-lg overflow-hidden max-w-70 h-1/1 w-2/3 bg-white min-w-40 min-h-40 max-h-70">
          ...
          <div className="group hover:cursor-pointer hover:to-background/10 z-2 relative left-0 bg-linear-to-l from-background to-background/0 h-1/1 w-1/8 min-w-10">
            <div className="flex h-1/1 w-1/1 justify-center items-center">
