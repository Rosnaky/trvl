        ...
        <div className="relative flex-col justify-center items-center">
          <div className="ml-auto mr-auto w-1/1 max-w-200 justify-center">
            <div className="overflow-hidden flex-row relative min-h-10 rounded-xl bg-white items-center border-1 border-gray-400 shadow-xl ring-black-800">
              ...
              <Link href="/build/step0" className="group absolute bg-theme-blue w-16 flex justify-center pr-1 right-0 top-0 bottom-0 hover:cursor-pointer h-1/1">
                ...
                <Image width="20" height="20" stroke="white" src={"/search.svg"} alt="" className="group-hover:scale-110 transition h-3/5 mt-1.5"/>
              </Link>
            </div>
